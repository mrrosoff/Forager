...
static const Forageable kSpecies[] = {
    ...
    {"Lung Lichen (Lobaria)", "lichen",
     ...
     MO(1) | MO(2) | MO(11) | MO(12), Biome::Forest},
    ...
    {"Wild Ginger", "root", "Heart-shaped leaf, gingery smell when crushed.",
     ...
     "Crush a leaf to confirm the ginger scent first.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Licorice Fern", "root", "Small fern on mossy maple limbs, sweet rhizome.", "",
     "Peel the rhizome off maple bark and chew raw.", MO(10) | MO(11) | MO(12) | MO(1),
     Biome::Forest},
    ...
    {"Camas", "root", "Blue-flowered lily bulb, a traditional root staple.",
     ...
     "Mark plants at bloom, then dig after flowers fade.", MO(6) | MO(7), Biome::Forest},

    {"Wapato", "root", "Arrowhead-leaf pond plant, starchy tuber.", "",
     "Tread mud with bare feet until tubers float up.", MO(9) | MO(10) | MO(11), Biome::Forest},
    ...
    {"Biscuitroot", "root", "Feathery carrot-family leaf, starchy taproot.",
     ...
     "carefully.",
     "Dig in open rocky soil; confirm by smell and leaf.", MO(3) | MO(4) | MO(5), Biome::Forest},
    ...
    {"Oregon Grape Root", "root", "Bright yellow woody root under holly-like leaves.",
     ...
     "Dig a side root, leave the main plant rooted.", MO(10) | MO(11) | MO(12), Biome::Forest},
    ...
    {"Cascara Bark", "bark", "Chittam bark, historic mild-laxative remedy.",
     ...
     "Strip small bark sections, then dry or age before use.", MO(4) | MO(5) | MO(6),
     Biome::Forest},
    ...
    {"Nodding Onion", "root", "Wild onion, pink drooping flower umbel.",
     ...
     "Confirm the onion smell, then pull the small bulb.", MO(6) | MO(7), Biome::Forest},
    ...
    {"American Bistort", "root", "Pink bottlebrush flowers over a chestnut-like root.", "",
     ...
     MO(8) | MO(9) | MO(10), Biome::Mountain},
    ...
    {"Wila (Horsehair Lichen)", "lichen", "Black hair-lichen draped on subalpine conifer limbs.",
     ...
     MO(10) | MO(11) | MO(12) | MO(1), Biome::Mountain},
    ...
    {"Rock Tripe", "lichen", "Leathery lichen patches clinging to alpine boulders.",
     ...
     "Peel dry, brittle patches off sun-exposed rock faces.", MO(7) | MO(8) | MO(9),
     Biome::Mountain},
    ...
    {"Glacier Lily Corm", "root", "Yellow snowmelt bloom hiding a once-staple corm below.",
     ...
     "Dig gently right at the melting snowline where blooms cluster.", MO(6) | MO(7),
     Biome::Mountain},
    ...
    {"Bitterroot", "root", "Fleshy taproot in rocky openings; peel away the bitter skin.", "",
     "Dig before the flower opens, when the root is plumpest.", MO(5) | MO(6), Biome::Mountain},
    ...
    {"Biscuitroot (Cous)", "root", "Parsnip-like root historically ground into a trail flour.",
     ...
     "Dig on dry rocky slopes before the flowering stalks dry out.", MO(5) | MO(6),
     Biome::Mountain},
    ...
    {"Yampah", "root", "Sweet carrot-family tuber found in damp mountain meadows.",
     ...
     "Dig moist meadow clumps only once flowers confirm the true plant.", MO(7) | MO(8),
     Biome::Mountain},

    {"Balsamroot", "root", "Big yellow sunflower on dry slopes; root needs long, slow cooking.", "",
     "Dig deep, fibrous taproots in fall after the seeds have set.", MO(9) | MO(10),
     Biome::Mountain},
    ...
    {"Camas Bulb", "root", "Blue-flowered meadow bulb, historically pit-roasted for weeks.",
     ...
     "Dig only when the blue flowers are visible, never past bloom.", MO(5) | MO(6),
     Biome::Mountain},
    ...
    {"Angelica Root", "root",
     ...
     "Dig streamside clumps only after confirming ID with a local expert.", MO(7) | MO(8),
     Biome::Mountain},
    ...
    {"Valerian Root", "root", "Pungent subalpine meadow root brewed into a calming tea.",
     ...
     "Dig damp meadow clumps in fall once the leaves start to yellow.", MO(9) | MO(10),
     Biome::Mountain},
    ...
    {"Springbank Clover", "root", "Traditional root vegetable from tidal marsh meadows.",
     ...
     "Dig slender roots in fall once the leaves die back.", MO(9) | MO(10) | MO(11), Biome::Coast},
    ...
    {"Common Camas", "root", "Blue-flowered bulb in coastal prairie meadows.",
     ...
     "Dig bulbs after bloom in old Garry oak prairie meadows.", MO(5) | MO(6), Biome::Coast},

    {"Chocolate Lily", "root", "Checkered maroon flower over a rice-grain bulb cluster.", "",
     "Dig bulbs in open coastal meadows just after bloom.", MO(4) | MO(5), Biome::Coast},
