// foraging_species.h — the master PNW/Seattle foraging reference table.
// Pure data, split out of foraging.cpp so that file is mostly logic. Only
// included from foraging.cpp, which #defines the MO(month) bitmask macro
// used throughout before including this.
#pragma once
...
static const Forageable kSpecies[] = {
    ...
    {"Miner's Lettuce", "green", "Round leaf cupping the stem. Shady wet banks.", "",
     "Snip above the root so the patch regrows.", MO(1) | MO(2) | MO(3), Biome::Forest},

    {"Stinging Nettle", "green", "First tips now. Gloves on; cooking kills the sting.",
     "Wear gloves -- fresh leaves sting on contact.",
     "Pick only the top 4-6 leaves per plant, gloved.", MO(2) | MO(3) | MO(4), Biome::Forest},
    ...
    {"Morel", "mushroom", "Honeycomb cap. Watch cottonwoods as soil warms.",
     ...
     "Check burn sites and cottonwood river bottoms.", MO(3) | MO(4), Biome::Forest},

    {"Chickweed", "green", "Tender mats in disturbed ground. Mild, fresh.", "",
     "Best before flowering; snip the top few inches.", MO(3) | MO(4) | MO(5), Biome::Forest},

    {"Ramps", "green", "Wild leek. Harvest one leaf, leave the bulb.", "",
     "Take a single leaf per plant so the patch survives.", MO(4), Biome::Forest},
    ...
    {"Fiddlehead Fern", "green", "Tight coils of lady fern. Pick before they unfurl.",
     ...
     "Snap coils that are still tightly curled, under 2 inches.", MO(4) | MO(5), Biome::Forest},
    ...
    {"Elderflower", "flower", "Creamy umbels. Cordial weather. Never the leaves.",
     ...
     "Cut whole flower clusters, shake off insects first.", MO(5) | MO(6), Biome::Forest},

    {"Wood Sorrel", "green", "Shamrock leaf, lemony bite. Forest floor and trailside.",
     "High in oxalic acid -- a trailside nibble, not a meal.",
     "Pinch leaves and stems; avoid roadside patches.", MO(5) | MO(6) | MO(7), Biome::Forest},

    {"Salmonberry", "berry", "Earliest berry. Golden to red, along streams.", "",
     "Ripe berries pull free easily; unripe ones resist.", MO(6), Biome::Forest},
    ...
    {"Chanterelle", "mushroom", "Apricot scent, false gills. Conifer duff after warm rain.",
     ...
     "Look on slopes under Douglas fir a week after rain.", MO(7) | MO(8) | MO(9), Biome::Forest},

    {"Blackberry", "berry", "Himalayan brambles everywhere. Sun-warmed edges.", "",
     "Sun-facing berries ripen first; watch for thorns.", MO(8) | MO(9), Biome::Forest},

    {"Matsutake", "mushroom", "Spicy-cinnamon pine mushroom. Sandy conifer soil.", "",
     "Look for cracked duff mounds near pine roots.", MO(9), Biome::Forest},
    ...
    {"Lobster Mushroom", "mushroom", "Orange parasitized host. Firm, seafood-sweet.",
     ...
     "Firm all the way through means it's good to eat.", MO(9) | MO(10), Biome::Forest},

    {"Porcini", "mushroom", "King bolete. Fat white stem, no gills -- pores instead.",
     "Check for pores, not gills; avoid soft or wormy caps.",
     "Firm caps only; check the stem base for grubs.", MO(10), Biome::Forest},
    ...
    {"Huckleberry", "berry", "Subalpine slopes. Ripens as you gain elevation.", "",
     "Higher elevation = later ripening; chase the season uphill.", MO(7) | MO(8), Biome::Mountain},

    {"Raspberry", "berry", "Wild cane fruit at forest edges and old clearings.", "",
     "Tug ripe berries gently -- they pull free of the core when ready.", MO(7) | MO(8),
     Biome::Mountain},
    ...
    {"Douglas Fir Tips", "flower", "Bright citrus-pine new growth at branch ends.",
     ...
     "Pinch only the pale new candle growth, not old needles.", MO(4) | MO(5), Biome::Mountain},
    ...
    {"Sugar Kelp", "seaweed", "Wavy golden-brown blade in the low intertidal.", "",
     "Cut blades an inch above the holdfast at a minus tide.", MO(5) | MO(6) | MO(7), Biome::Coast},
    ...
    {"Silverweed", "green", "Silvery-leaved runner in upper tidal meadows.", "",
     "Dig slender roots in fall after the leaves die back.", MO(9) | MO(10), Biome::Coast},

    {"Beach Strawberry", "berry", "Low dune mats, small intensely sweet fruit.", "",
     "Search sandy, sun-facing dune grass for ripe red fruit.", MO(7) | MO(8), Biome::Coast},
    ...
    {"Wild Rose Hips", "berry", "Bright orange-red hips on beach and hedgerow roses.",
     ...
     "Pick after the first frost sweetens the hip.", MO(9) | MO(10), Biome::Coast},
    ...
    {"Turkey Tail", "mushroom", "Thin banded fan-shelves in rainbow stripes on logs.",
     ...
     MO(9) | MO(10) | MO(11) | MO(12) | MO(1), Biome::Forest},
    ...
    {"Artist's Conk", "mushroom",
     ...
     MO(1) | MO(9) | MO(10) | MO(11) | MO(12), Biome::Forest},
    ...
    {"Shrimp Russula", "mushroom", "Reddish-pink cap, brittle white gills, mild in conifer duff.",
     ...
     "Look for brittle, chalky-snapping stems under Douglas fir.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Golden Chanterelle", "mushroom",
     ...
     "blunt false ridges.",
     "Search mossy Douglas fir slopes a week after a warm rain.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Admirable Bolete", "mushroom", "Reddish-brown cap, yellow pores, firm flesh under conifers.",
     ...
     "Check firm, dry-capped boletes on well-drained forest slopes.", MO(9) | MO(10),
     Biome::Forest},
    ...
    {"Witch's Butter", "mushroom",
     ...
     MO(11) | MO(12) | MO(1) | MO(2), Biome::Forest},
    ...
    {"Oregon White Truffle", "mushroom",
     ...
     MO(10) | MO(11) | MO(12) | MO(1), Biome::Forest},

    {"Thimbleberry", "berry", "Maple-like leaf, soft red thimble-shaped fruit.", "",
     "Pick berries that crumble off the cap easily.", MO(7) | MO(8), Biome::Forest},

    {"Salal", "berry", "Evergreen leathery leaf, dark blue-black berry.", "",
     "Strip ripe dark berries off the flower spike.", MO(8) | MO(9), Biome::Forest},

    {"Red Huckleberry", "berry", "Bright red berry on angled green twigs on stumps.", "",
     "Check old nurse logs and stumps in shade.", MO(7) | MO(8), Biome::Forest},
    ...
    {"Blue Elderberry", "berry", "Powdery blue-black clusters on tall shrubs.",
     ...
     "Cut whole clusters, then cook before eating.", MO(8) | MO(9), Biome::Forest},

    {"Serviceberry", "berry", "Saskatoon. Sweet purple fruit in loose clusters.", "",
     "Strip ripe purple berries into a bag by hand.", MO(6) | MO(7), Biome::Forest},
    ...
    {"Kinnikinnick", "berry", "Bearberry. Mealy red fruit on trailing mats.",
     ...
     "Best simmered into syrup; raw fruit is dry.", MO(9) | MO(10) | MO(11), Biome::Forest},

    {"Trailing Blackberry", "berry", "Native bramble, low vines, smaller sweeter fruit.", "",
     "Search low along the ground, not tall canes.", MO(7) | MO(8), Biome::Forest},
    ...
    {"Indian Plum", "berry", "Earliest native bloom; bitter-to-sweet oval fruit.",
     ...
     "Wait for fruit to turn dark blue-black.", MO(6) | MO(7), Biome::Forest},

    {"Wild Strawberry", "berry", "Tiny intensely sweet fruit in forest openings.", "",
     "Search sunny forest-edge clearings and old trails.", MO(6) | MO(7), Biome::Forest},
    ...
    {"Bunchberry", "berry", "Dwarf dogwood, tight red berry cluster on the floor.",
     ...
     "Look on mossy forest floor for the red cluster.", MO(8) | MO(9), Biome::Forest},

    {"Wine Cap Mushroom", "mushroom", "Burgundy cap fading tan, thick white ring, grows in wood-chip beds.",
     "No toxic lookalikes once the ring and chip habitat are confirmed.",
     "Check municipal wood-chip beds and garden mulch after rain.", MO(5) | MO(6) | MO(9) | MO(10), Biome::Forest},

    {"Sheep Sorrel", "green", "Arrow-shaped leaf, sharp lemony bite.",
     "High in oxalic acid -- a trailside nibble, not a meal.",
     "Pinch young leaves from sunny disturbed ground.", MO(4) | MO(5) | MO(6), Biome::Forest},
    ...
    {"Plantain", "green", "Ribbed oval leaf in every lawn and trail edge.", "",
     "Pick tender young leaves from unsprayed ground.", MO(5) | MO(6) | MO(7), Biome::Forest},
    ...
    {"Watercress", "green", "Peppery green mat rooted in cold running water.",
     ...
     "Gather from clean, fast-flowing streams only.", MO(4) | MO(5) | MO(10), Biome::Forest},

    {"Wild Mint", "green", "Square stem, minty scent, streamside patches.", "",
     "Crush a leaf to confirm the mint scent first.", MO(6) | MO(7) | MO(8), Biome::Forest},
    ...
    {"Saffron Milk Cap", "mushroom", "Orange cap that bleeds carrot-colored milk when cut, stains green with age.",
     ...
     "Search under pine plantations after fall rain.", MO(9) | MO(10) | MO(11), Biome::Forest},

    {"Shaggy Parasol", "mushroom", "Large shaggy-scaled cap, ring on stem, browns when bruised.",
     "Confirm the ring and scaly cap -- a few Lepiota relatives are toxic.",
     "Look in grassy forest edges and clearings.", MO(8) | MO(9) | MO(10), Biome::Forest},

    {"Douglas Aster", "flower", "Lavender daisy-like blooms along forest edges and clearings in late summer.", "",
     "Pick the petals fresh; whole flowerheads are edible as a garnish.", MO(8) | MO(9) | MO(10), Biome::Forest},

    {"Beaked Hazelnut", "nut", "Native filbert in a bristly beaked husk.",
     "Husks have irritating fine bristles -- wear gloves when hulling.",
     "Gather husked nuts once they drop to the ground.", MO(8) | MO(9), Biome::Forest},
    ...
    {"Garry Oak Acorn", "nut", "Oak acorn needing leaching before eating.",
     ...
     "Shell, chop, and soak in changed water to leach tannin.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Red-Flowering Currant", "berry", "Bland blue-black fruit follows the pink spring bloom.", "",
     "Best cooked into jam -- raw berries are mealy and mild.", MO(7) | MO(8), Biome::Mountain},
    ...
    {"King Bolete Button", "mushroom", "Young unopened Boletus edulis, firm white pores, before the cap flattens.",
     ...
     "Check conifer duff a few days after warm rain.", MO(8) | MO(9) | MO(10), Biome::Mountain},

    {"Alpine Blueberry", "berry", "Low sprawling shrub with powdery blue berries just above treeline.", "",
     "Best right where the shrub barely clears the ground near rock fields.", MO(8) | MO(9), Biome::Mountain},

    {"Subalpine Daisy", "flower", "Lavender-rayed daisy with a yellow center, carpeting subalpine meadows.", "",
     "Petals make a mild garnish; pick from large stands only.", MO(7) | MO(8), Biome::Mountain},
    ...
    {"Labrador Tea", "green", "Fuzzy-backed leaves in subalpine bogs, brewed as tea.",
     ...
     "Pick a few leathery leaves, dry them before brewing.", MO(6) | MO(7) | MO(8),
     Biome::Mountain},
    ...
    {"Whitebark Pine Nuts", "pine nut", "Fat, buttery seed from a threatened high-elevation pine.",
     ...
     "Look for cones already dropped below snags near ridgelines.", MO(8) | MO(9), Biome::Mountain},
    ...
    {"Grand Fir Tips", "tree tip", "Glossy needles with a bright orange-citrus scent when crushed.",
     "Don't confuse with Pacific yew -- yew needles are toxic.",
     "Take a few soft new tips per branch and leave the rest.", MO(4) | MO(5), Biome::Mountain},

    {"Wild Gooseberry", "berry", "Spiny stems, dangling purple-veined berries in damp mountain draws.",
    ...
    {"Mountain Sorrel Leaves", "green", "Small kidney-shaped leaves with a sharp lemony bite, tucked in rocky seeps.", "",
     "Pick a few young leaves per plant from rocky wet crevices.", MO(6) | MO(7) | MO(8), Biome::Mountain},

    {"Subalpine Fireweed", "flower", "Tall pink-purple spikes colonizing high slopes after snowmelt or fire.", "",
     "Pick individual flowers as they open up the spike.", MO(7) | MO(8), Biome::Mountain},
    ...
    {"Red Elderberry", "berry",
     ...
     "Cook thoroughly and strain out seeds; never eat raw.", MO(6) | MO(7), Biome::Mountain},
    ...
    {"Bladderwrack", "seaweed", "Forked brown fronds with paired air bladders.", "",
     ...
     MO(4) | MO(5) | MO(6) | MO(7) | MO(8), Biome::Coast},
    ...
    {"Sea Palm", "seaweed", "Palm-like stipe braced in the crashing surf zone.",
     ...
     "Cut a few fronds per holdfast so the cluster regrows.", MO(6) | MO(7) | MO(8), Biome::Coast},
    ...
    {"Turkish Towel", "seaweed", "Thick rubbery red blade, rough like a washcloth.", "",
     "Peel whole blades from low rocks at a minus tide.", MO(6) | MO(7) | MO(8) | MO(9),
     Biome::Coast},
    ...
    {"Sea Sac", "seaweed", "Golf-ball brown blobs stuck fast to low rocks.", "",
     "Twist whole sacs free at the lowest summer tides.", MO(6) | MO(7) | MO(8), Biome::Coast},

    {"Oarweed", "seaweed", "Broad divided blade, thick rubbery stipe, low rocky shore.", "",
     "Cut blades above the holdfast at a low tide, leaving it rooted.",
     MO(5) | MO(6) | MO(7) | MO(8), Biome::Coast},
    ...
    {"Giant Kelp", "seaweed", "Towering brown kelp forest off the open coast.", "",
     ...
     MO(6) | MO(7) | MO(8) | MO(9) | MO(10), Biome::Coast},
    ...
    {"Dungeness Crab", "shellfish", "Iconic sweet-meat crab of eelgrass and sandy flats.",
     ...
     MO(7) | MO(8) | MO(9) | MO(10) | MO(11) | MO(12), Biome::Coast},
    ...
    {"Red Rock Crab", "shellfish", "Smaller, chunky-clawed crab under low-tide rocks.",
     ...
     MO(4) | MO(5) | MO(6) | MO(7) | MO(8) | MO(9), Biome::Coast},
    ...
    {"Purple Varnish Clam", "shellfish", "Shiny purple-brown shell, shallow in sandy beaches.",
     ...
     MO(3) | MO(4) | MO(5) | MO(6) | MO(7) | MO(8) | MO(9) | MO(10), Biome::Coast},
    ...
    {"Kelp Crab", "crab", "Olive, spider-legged crab living in kelp beds.", "",
     "Hand-pick from kelp holdfasts at a low tide.", MO(6) | MO(7) | MO(8) | MO(9), Biome::Coast},

    {"Graceful Crab", "crab", "Smaller cousin of Dungeness, a common bycatch.", "",
     "Found in the same pots and pools as Dungeness crab.", MO(7) | MO(8) | MO(9), Biome::Coast},
    ...
    {"Spot Prawn", "shrimp", "Sweet pink shrimp with a very short spring season.",
     ...
     "Drop baited pots into deep water off the outer coast.", MO(5), Biome::Coast},
    ...
    {"Pig's Ears", "mushroom", "Purple-brown, vase-shaped chanterelle relative in mossy duff.",
     ...
     "Look near hemlock roots where moss stays damp.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Woolly Chanterelle", "mushroom", "Shaggy orange funnel, showy but upsets stomachs raw.",
     ...
     "Easy to spot by its ragged, scaly orange cap.", MO(9) | MO(10), Biome::Forest},
    ...
    {"Dryad's Saddle", "mushroom", "Big scaly tan bracket smelling of watermelon rind, on hardwood wounds.",
     "Pick only young, still-tender brackets -- older ones turn woody, not toxic just inedible.",
     "Check fresh wounds and stumps on maple and cottonwood each spring.", MO(4) | MO(5) | MO(6), Biome::Forest},
    ...
    {"Sword Fern", "fern", "Evergreen forest fern; rhizome was an emergency staple.",
     ...
     MO(1) | MO(2) | MO(3) | MO(10) | MO(11) | MO(12), Biome::Forest},
